...
project = 'faltwerk'
copyright = '2021-2022, Adrian Viehweger'
...
release = get_distribution('faltwerk').version
...
latex_documents = [
    (master_doc, 'faltwerk.tex', 'faltwerk Documentation',
     'Adrian Viehweger', 'manual'),
]
...
man_pages = [
    (master_doc, 'faltwerk', 'faltwerk Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'faltwerk', 'faltwerk Documentation',
     author, 'faltwerk', 'One line description of project.',
     'Miscellaneous'),
]
...
autodoc_mock_imports = ["faltwerk.models.Fold"]
